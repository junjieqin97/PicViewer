...
class MainWindowUI:
    ...
    def _apply_shortcuts(self) -> None:
        ...
        self.actPeakHigh.setShortcut(QtGui.QKeySequence(f"{modifier}+F, 3"))
        self.actPeakMedium.setShortcut(QtGui.QKeySequence(f"{modifier}+F, 2"))
        self.actPeakLow.setShortcut(QtGui.QKeySequence(f"{modifier}+F, 1"))
